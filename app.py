...
<style>
    ...
    .startup-button {
        ...
        margin-bottom: 30px;
        transition: all 0.3s ease;
        animation: buttonFadeIn 2.2s ease-out 0.9s both;
    }
...
<div id="appStartup" class="app-startup-overlay">
    ...
    <button class="startup-button" onclick="hideStartupAnimation()">START</button>
    <div class="startup-title-compact">台北運動場地搜尋引擎 - 找到最適合您的運動場地</div>
</div>
